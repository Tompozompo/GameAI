...
F1SpiritApp::F1SpiritApp()
{
	...
	menu_multiplayer_n_enemycars = 23;
	menu_multiplayer_enemy_speed = 1;
    menu_selected_car[0] = 2;
    menu_selected_car[1] = 2;
    menu_selected_car[2] = 2;
    menu_selected_car[3] = 2;
